...
const AlsoBought = () => {
  ...
  useEffect(() => {
    const fetchDataFromFirebase = async () => {
      try {
        ...
        // Filter items that match the current gender, category, and have a different subcategory
        const filteredItems = data.filter(item => (
          item.gender === gender &&
          item.category === category &&
          item.subcategory !== subcategory // Include only items with different subcategory
        ));
        ...
        console.log("This is Filtered Items", filteredItems)
      } catch (error) {
  ...
  console.log("This is categoryProducts", categoryProducts)
